package org.piet.forumbackend.fishing_spots.core.controllers;
...
@Tag(name = "Admin - fishing spots", description = "Endpoints for admin's spot management.")
public class FishingSpotAdminController {
    private final FishingSpotService fishingSpotService;

    @GetMapping("/unverified")
    public ResponseEntity<PageDto<FishingSpotListDto>> getUnverified(PaginationDto pagination){
        var spots = fishingSpotService.getFishingSpotDtosByStatus(VerificationStatus.IN_REVIEW, pagination.toPageable());
