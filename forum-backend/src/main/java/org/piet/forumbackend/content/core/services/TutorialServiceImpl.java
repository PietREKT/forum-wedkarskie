...
import org.piet.forumbackend.content.core.repositories.TutorialRepository;
...
public class TutorialServiceImpl implements TutorialService {
    ...
    public TutorialDto createTutorial(User author, String title, String content, List<MultipartFile> photos) throws UnauthorizedAccessException, IOException {
        ...
        tutorial.setContentType(ContentType.TUTORIAL);
    ...
    public Page<TutorialDto> getTutorialsByMethod(FishingMethod method, Pageable pageable) {
        return tutorialRepository.findByMethod(method, VerificationStatus.ACCEPTED,pageable).map(TutorialDtoMapper::toTutorialDto);
    }

    @Override
    public Page<TutorialDto> getTutorialsByFish(Fish fish, Pageable pageable) {
        return tutorialRepository.findByFish(fish, VerificationStatus.ACCEPTED, pageable).map(TutorialDtoMapper::toTutorialDto);
    }
