package org.piet.forumbackend.content.core.controllers.admins;

import io.swagger.v3.oas.annotations.tags.Tag;
import jakarta.validation.Valid;
import lombok.RequiredArgsConstructor;
import org.piet.forumbackend.content.core.dtos.requests.tutorials.RejectTutorialDto;
...
@Tag(name = "Admin - tutorials", description = "Endpoints for admin tutorial management.")
